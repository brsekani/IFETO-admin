    ...
    <div className="bg-[#FAFAFA] space-y-8 min-h-[85vh] h-full flex flex-col">
      <div className="space-y-5">
        <div className="flex items-start justify-between">
          ...
          <div className="px-5 py-2.5 bg-[#27AE60] rounded-[6px] text-[18px] leading-8 text-[#FFFFFF] font-semibold hidden md:flex items-center gap-2.5 cursor-pointer">
      ...
      <div className="flex-1 flex w-full">
        {orders.length === 0 ? (
          ...
          <div className="w-full">
            <ProductTable products={orders} isLoading={false} />
          </div>
        )}
      </div>
    </div>
